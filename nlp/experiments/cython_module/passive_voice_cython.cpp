...
#define __PYX_HAVE__passive_voice_cython
#define __PYX_HAVE_API__passive_voice_cython
/* Early includes */
#include <string.h>
#include <stdio.h>
...
struct __pyx_t_20passive_voice_cython_DocElement;

/* "passive_voice_cython.pyx":11
...
/* Module declarations from 'passive_voice_cython' */
...
static int __pyx_f_20passive_voice_cython_fast_loop(struct __pyx_t_20passive_voice_cython_DocElement *, int, __pyx_t_5spacy_8typedefs_hash_t); /*proto*/
static PyObject *__pyx_f_20passive_voice_cython_main_nlp_fast(PyObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "passive_voice_cython"
extern int __pyx_module_is_main_passive_voice_cython;
int __pyx_module_is_main_passive_voice_cython = 0;

/* Implementation of 'passive_voice_cython' */
...
static PyObject *__pyx_pf_20passive_voice_cython_main_nlp_fast(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_doc_list); /* proto */
...
static int __pyx_f_20passive_voice_cython_fast_loop(struct __pyx_t_20passive_voice_cython_DocElement *__pyx_v_docs, int __pyx_v_n_docs, __pyx_t_5spacy_8typedefs_hash_t __pyx_v_tag) {
  int __pyx_v_n_out;
  struct __pyx_t_20passive_voice_cython_DocElement __pyx_v_doc;
  struct __pyx_t_5spacy_7structs_TokenC __pyx_v_c;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  struct __pyx_t_20passive_voice_cython_DocElement *__pyx_t_1;
  struct __pyx_t_20passive_voice_cython_DocElement *__pyx_t_2;
  struct __pyx_t_20passive_voice_cython_DocElement *__pyx_t_3;
  struct __pyx_t_5spacy_7structs_TokenC *__pyx_t_4;
  struct __pyx_t_5spacy_7structs_TokenC *__pyx_t_5;
  struct __pyx_t_5spacy_7structs_TokenC *__pyx_t_6;
  int __pyx_t_7;
  __Pyx_RefNannySetupContext("fast_loop", 0);

  /* "passive_voice_cython.pyx":16
 * 
 * cdef int fast_loop(DocElement* docs, int n_docs, hash_t tag):
 *     cdef int n_out = 0             # <<<<<<<<<<<<<<
 *     for doc in docs[:n_docs]:
 ...
 *             if c.tag == tag:
 */
  __pyx_t_2 = (__pyx_v_docs + __pyx_v_n_docs);
  for (__pyx_t_3 = __pyx_v_docs; __pyx_t_3 < __pyx_t_2; __pyx_t_3++) {
    __pyx_t_1 = __pyx_t_3;
    __pyx_v_doc = (__pyx_t_1[0]);

    /* "passive_voice_cython.pyx":18
 *     cdef int n_out = 0
 *     for doc in docs[:n_docs]:
 *         for c in doc.c[:doc.length]:             # <<<<<<<<<<<<<<
 *             if c.tag == tag:
 *                 n_out += 1
 */
    __pyx_t_5 = (__pyx_v_doc.c + __pyx_v_doc.length);
    for (__pyx_t_6 = __pyx_v_doc.c; __pyx_t_6 < __pyx_t_5; __pyx_t_6++) {
      __pyx_t_4 = __pyx_t_6;
      __pyx_v_c = (__pyx_t_4[0]);

      /* "passive_voice_cython.pyx":19
 *     for doc in docs[:n_docs]:
 *         for c in doc.c[:doc.length]:
 *             if c.tag == tag:             # <<<<<<<<<<<<<<
 *                 n_out += 1
 *     return n_out
 */
      __pyx_t_7 = ((__pyx_v_c.tag == __pyx_v_tag) != 0);
      if (__pyx_t_7) {

        /* "passive_voice_cython.pyx":20
 *         for c in doc.c[:doc.length]:
 *             if c.tag == tag:
 *                 n_out += 1             # <<<<<<<<<<<<<<
 *     return n_out
...
static PyObject *__pyx_pw_20passive_voice_cython_1main_nlp_fast(PyObject *__pyx_self, PyObject *__pyx_v_doc_list); /*proto*/
static PyObject *__pyx_f_20passive_voice_cython_main_nlp_fast(PyObject *__pyx_v_doc_list, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_n_out;
  int __pyx_v_n_docs;
  struct __pyx_obj_5cymem_5cymem_Pool *__pyx_v_mem = 0;
  struct __pyx_t_20passive_voice_cython_DocElement *__pyx_v_docs;
  struct __pyx_obj_5spacy_6tokens_3doc_Doc *__pyx_v_doc = 0;
  PyObject *__pyx_v_tag_hash = NULL;
 ...
 */
  __pyx_t_1 = PyObject_Length(__pyx_v_doc_list); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 24, __pyx_L1_error)
  __pyx_v_n_docs = __pyx_t_1;

  /* "passive_voice_cython.pyx":25
 * cpdef main_nlp_fast(doc_list):
 *     cdef int i, n_out, n_docs = len(doc_list)
 *     cdef Pool mem = Pool()             # <<<<<<<<<<<<<<
 *     cdef DocElement* docs = <DocElement*>mem.alloc(n_docs, sizeof(DocElement))
 *     cdef Doc doc
 */
  __pyx_t_2 = __Pyx_PyObject_CallNoArg(((PyObject *)__pyx_ptype_5cymem_5cymem_Pool)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_v_mem = ((struct __pyx_obj_5cymem_5cymem_Pool *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "passive_voice_cython.pyx":26
 *     cdef int i, n_out, n_docs = len(doc_list)
 *     cdef Pool mem = Pool()
 *     cdef DocElement* docs = <DocElement*>mem.alloc(n_docs, sizeof(DocElement))             # <<<<<<<<<<<<<<
 *     cdef Doc doc
 ...
 */
  __pyx_t_3 = ((struct __pyx_vtabstruct_5cymem_5cymem_Pool *)__pyx_v_mem->__pyx_vtab)->alloc(__pyx_v_mem, __pyx_v_n_docs, (sizeof(struct __pyx_t_20passive_voice_cython_DocElement))); if (unlikely(__pyx_t_3 == ((void *)NULL))) __PYX_ERR(0, 26, __pyx_L1_error)
  __pyx_v_docs = ((struct __pyx_t_20passive_voice_cython_DocElement *)__pyx_t_3);

  /* "passive_voice_cython.pyx":28
 *     cdef DocElement* docs = <DocElement*>mem.alloc(n_docs, sizeof(DocElement))
 *     cdef Doc doc
 *     for i, doc in enumerate(doc_list): # Populate our database structure             # <<<<<<<<<<<<<<
 *         docs[i].c = doc.c
 ...
 */
  ...
  if (likely(PyList_CheckExact(__pyx_v_doc_list)) || PyTuple_CheckExact(__pyx_v_doc_list)) {
    ...
    __pyx_t_1 = -1; __pyx_t_2 = PyObject_GetIter(__pyx_v_doc_list); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
  ...
  for (;;) {
    if (likely(!__pyx_t_5)) {
      if (likely(PyList_CheckExact(__pyx_t_2))) {
        ...
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_6 = PyTuple_GET_ITEM(__pyx_t_2, __pyx_t_1); __Pyx_INCREF(__pyx_t_6); __pyx_t_1++; if (unlikely(0 < 0)) __PYX_ERR(0, 28, __pyx_L1_error)
        #else
        __pyx_t_6 = PySequence_ITEM(__pyx_t_2, __pyx_t_1); __pyx_t_1++; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 28, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        #endif
    ...
    if (!(likely(((__pyx_t_6) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_6, __pyx_ptype_5spacy_6tokens_3doc_Doc))))) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_XDECREF_SET(__pyx_v_doc, ((struct __pyx_obj_5spacy_6tokens_3doc_Doc *)__pyx_t_6));
    __pyx_t_6 = 0;
    __pyx_v_i = __pyx_t_4;
    __pyx_t_4 = (__pyx_t_4 + 1);

    /* "passive_voice_cython.pyx":29
 *     cdef Doc doc
 *     for i, doc in enumerate(doc_list): # Populate our database structure
 *         docs[i].c = doc.c             # <<<<<<<<<<<<<<
 *         docs[i].length = (<Doc>doc).length
 ...
 *     print(n_out)
 */
  if (unlikely(!__pyx_v_doc)) { __Pyx_RaiseUnboundLocalError("doc"); __PYX_ERR(0, 31, __pyx_L1_error) }
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_doc->vocab->strings), __pyx_n_s_add); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_9 = NULL;
  ...
  __pyx_t_2 = (__pyx_t_9) ? __Pyx_PyObject_Call2Args(__pyx_t_6, __pyx_t_9, __pyx_n_s_NN) : __Pyx_PyObject_CallOneArg(__pyx_t_6, __pyx_n_s_NN);
  __Pyx_XDECREF(__pyx_t_9); __pyx_t_9 = 0;
  if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_v_tag_hash = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "passive_voice_cython.pyx":32
 *         docs[i].length = (<Doc>doc).length
 *     tag_hash = doc.vocab.strings.add('NN')
 *     n_out = fast_loop(docs, n_docs, tag_hash)             # <<<<<<<<<<<<<<
 *     print(n_out)
 */
  __pyx_t_10 = __Pyx_PyInt_As_uint64_t(__pyx_v_tag_hash); if (unlikely((__pyx_t_10 == ((uint64_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 32, __pyx_L1_error)
  __pyx_v_n_out = __pyx_f_20passive_voice_cython_fast_loop(__pyx_v_docs, __pyx_v_n_docs, __pyx_t_10);

  /* "passive_voice_cython.pyx":33
 *     tag_hash = doc.vocab.strings.add('NN')
 *     n_out = fast_loop(docs, n_docs, tag_hash)
 *     print(n_out)             # <<<<<<<<<<<<<<
 */
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_n_out); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_AddTraceback("passive_voice_cython.main_nlp_fast", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF((PyObject *)__pyx_v_mem);
  __Pyx_XDECREF((PyObject *)__pyx_v_doc);
  __Pyx_XDECREF(__pyx_v_tag_hash);
...
/* Python wrapper */
static PyObject *__pyx_pw_20passive_voice_cython_1main_nlp_fast(PyObject *__pyx_self, PyObject *__pyx_v_doc_list); /*proto*/
static PyObject *__pyx_pw_20passive_voice_cython_1main_nlp_fast(PyObject *__pyx_self, PyObject *__pyx_v_doc_list) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("main_nlp_fast (wrapper)", 0);
  __pyx_r = __pyx_pf_20passive_voice_cython_main_nlp_fast(__pyx_self, ((PyObject *)__pyx_v_doc_list));
...
static PyObject *__pyx_pf_20passive_voice_cython_main_nlp_fast(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_doc_list) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("main_nlp_fast", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_20passive_voice_cython_main_nlp_fast(__pyx_v_doc_list, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "passive_voice_cython.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "passive_voice_cython.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "passive_voice_cython.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "passive_voice_cython._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"main_nlp_fast", (PyCFunction)__pyx_pw_20passive_voice_cython_1main_nlp_fast, METH_O, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_passive_voice_cython(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_passive_voice_cython},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("spacy.tokens.doc"); if (unlikely(!__pyx_t_1)) __PYX_ERR(9, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_5spacy_6tokens_3doc_Doc = __Pyx_ImportType(__pyx_t_1, "spacy.tokens.doc", "Doc", sizeof(struct __pyx_obj_5spacy_6tokens_3doc_Doc), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5spacy_6tokens_3doc_Doc) __PYX_ERR(9, 38, __pyx_L1_error)
  __pyx_vtabptr_5spacy_6tokens_3doc_Doc = (struct __pyx_vtabstruct_5spacy_6tokens_3doc_Doc*)__Pyx_GetVtable(__pyx_ptype_5spacy_6tokens_3doc_Doc->tp_dict); if (unlikely(!__pyx_vtabptr_5spacy_6tokens_3doc_Doc)) __PYX_ERR(9, 38, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initpassive_voice_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initpassive_voice_cython(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_passive_voice_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_passive_voice_cython(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_passive_voice_cython(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'passive_voice_cython' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_passive_voice_cython(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("passive_voice_cython", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_passive_voice_cython) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "passive_voice_cython")) {
      if (unlikely(PyDict_SetItemString(modules, "passive_voice_cython", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init passive_voice_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init passive_voice_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
